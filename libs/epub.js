;(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof define === 'function' && define.amd) define(['xmldom', 'jszip'], factory)
        ...
        var EpubCFI = (function () {
          function EpubCFI(cfiFrom, base, ignoreClass) {
            ...
            if (typeof base === 'string') {
              ...
              (typeof base === 'undefined' ? 'undefined' : _typeof(base)) === 'object' &&
              base.steps
            ) {
              this.base = base
            }
          ...
          _createClass(EpubCFI, [
            {
              ...
              value: function checkType(cfi) {
                if (this.isCfiString(cfi)) {
                  ...
                  (typeof cfi === 'undefined' ? 'undefined' : _typeof(cfi)) === 'object' &&
                  ((0, _core.type)(cfi) === 'Range' || typeof cfi.startContainer != 'undefined')
                ) {
                  return 'range'
                } else if (
                  (typeof cfi === 'undefined' ? 'undefined' : _typeof(cfi)) === 'object' &&
            ...
            },
            {
              ...
              value: function adjustImages(contents) {
                ...
                contents.addStylesheetRules({
                  img: {
                    'max-width':
                      (this._layout.columnWidth ? this._layout.columnWidth + 'px' : '100%') +
                      '!important',
                    'max-height':
                      (this._layout.height ? this._layout.height * 0.6 + 'px' : '60%') +
                      '!important',
                    'object-fit': 'contain',
        ...
        var ContinuousViewManager = (function (_DefaultViewManager) {
          ...
          function ContinuousViewManager(options) {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (
                ContinuousViewManager.__proto__ || Object.getPrototypeOf(ContinuousViewManager)
              ).call(this, options)
            )
          ...
          _createClass(ContinuousViewManager, [
            {
              key: 'display',
              value: function display(section, target) {
                return _default2.default.prototype.display.call(this, section, target).then(
                  function () {
                    return this.fill()
                  }.bind(this)
                )
   ...
   */
          ...
          _createClass(Navigation, [
            ...
            },
            {
              ...
              value: function landmarkItem(item) {
                ...
                var type =
                  content.getAttributeNS('http://www.idpf.org/2007/ops', 'type') || undefined
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var Pane = (exports.Pane = (function () {
          function Pane(target) {
            var container =
              arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : document.body
        ...
        var Highlight = (exports.Highlight = (function (_Mark) {
          ...
          function Highlight(range, className, data, attributes) {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (Highlight.__proto__ || Object.getPrototypeOf(Highlight)).call(this)
            )
          ...
          _createClass(Highlight, [
            {
              ...
              value: function bind(element, container) {
                _get(
                  Highlight.prototype.__proto__ || Object.getPrototypeOf(Highlight.prototype),
                  'bind',
                  this
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        /* WEBPACK VAR INJECTION */ ;(function (global, module) {
            ...
            jURL.prototype = {
              ...
              get href() {
                ...
                if ('' != this._username || null != this._password) {
                  authority =
                    this._username + (null != this._password ? ':' + this._password : '') + '@'
                }
          ...
          /* WEBPACK VAR INJECTION */
        }).call(exports, __webpack_require__(8), __webpack_require__(70)(module))
